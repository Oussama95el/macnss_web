...
<%--&lt;%&ndash;      <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="relative h-16 flex items-center justify-between lg:border-b lg:border-indigo-400 lg:border-opacity-25">&ndash;%&gt;--%>
<%--&lt;%&ndash;          <div class="px-2 flex items-center lg:px-0">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="flex-shrink-0">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <img class="block h-8 w-8" src="https://tailwindui.com/img/logos/workflow-mark-indigo-300.svg" alt="Workflow">&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="hidden lg:block lg:ml-10">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <div class="flex space-x-4">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <!-- Current: "bg-indigo-700 text-white", Default: "text-white hover:bg-indigo-500 hover:bg-opacity-75" -->&ndash;%&gt;--%>
<%--&lt;%&ndash;                <a href="#" class="bg-cyan-800 text-white rounded-md py-2 px-3 text-sm font-medium" aria-current="page"> Dashboard </a>&ndash;%&gt;--%>

<%--&lt;%&ndash;              </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;          </div>&ndash;%&gt;--%>

<%--&lt;%&ndash;          <div class="flex lg:hidden">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <!-- Mobile menu button -->&ndash;%&gt;--%>
<%--&lt;%&ndash;            <button type="button" class="bg-indigo-600 p-2 rounded-md inline-flex items-center justify-center text-indigo-200 hover:text-white hover:bg-indigo-500 hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">&ndash;%&gt;--%>
<%--&lt;%&ndash;              <span class="sr-only">Open main menu</span>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <svg class="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>&ndash;%&gt;--%>
<%--&lt;%&ndash;              </svg>&ndash;%&gt;--%>
<%--&lt;%&ndash;              <svg class="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">&ndash;%&gt;--%>
...
<%--            </c:forEach>--%>
        ...
        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12" x-data="{step: 1}" x-show="displayForm">
          ...
          <form action="/dossier/new" class="space-y-4" method="post" x-data="{patientNumber: '', consulType: '', countMeds: 1, countDocs: 1}">

            <%-- step 1 --%>
            <div class="mt-5 flex flex-col items-center" x-show=" step == 1">
              <div class="my-2 w-1/2">
                <label class="sr-only" for="patientId">Patient Number</label>
                <input x-model="patientNumber" required name="patientId" type="number" placeholder="Patient Number" id="patientId" class="w-full rounded-lg border border-gray-600 p-3 text-sm"  />
              </div>
              ...
              <div class="w-1/2">
                <fieldset class="flex flex-wrap gap-3 justify-between" x-init="$watch('consulType', value => console.log(value))">
                  ...
                  <div>
                    <input x-model="consulType" type="radio" name="consType" value="80" id="generalist" class="peer hidden" />
                    <label
                            for="generalist"
                  ...
                  <div>
                    <input x-model="consulType" type="radio" name="consultation" value="120" id="specialist" class="peer hidden" checked />
                    <label
                            for="specialist"
                            class="flex cursor-pointer items-center justify-center rounded-md border border-gray-600 py-2 px-3 text-gray-900 hover:border-gray-200 peer-checked:border-blue-500 peer-checked:bg-blue-500 peer-checked:text-white"
                    >
            ...
            <div :class=" step == 1 ? 'mt-4 flex justify-end' : 'mt-4 flex justify-between'">
              ...
              <div class="flex justify-end">
                ...
                <button type="submit" class="inline-flex w-full items-center justify-center rounded-lg bg-cyan-600 px-5 py-3 text-white sm:w-auto">
